...
namespace MyCalendar.Calendar
{
    public class Calendar : Control
    {
        ...
        public void BuildCalendar(DateTime targetDate, System.Collections.Generic.Dictionary<DateTime, string> notesForTheMonth = null)
        {
            Days.Clear();
            ...
            for (int box = 1; box <= 42; box++)
            {
                ...
                if (notesForTheMonth!=null && notesForTheMonth.ContainsKey(day.Date) )
                {
                    day.Notes = notesForTheMonth[day.Date];
                }
                Days.Add(day);
                d = d.AddDays(1);
            }
