...
{
    public class ZakazanaPreraspodelaStatickeOpremeDTO
    {
        ...
        public ZakazanaPreraspodelaStatickeOpremeDTO() { }

        public ZakazanaPreraspodelaStatickeOpremeDTO(String brojSobeIz, String brojSobeU, DateTime datumIVreme, double trajanje, String nazivOpreme, int kolicina)
        {
